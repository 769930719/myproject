...
//         .pipe(gulp.dest('public/javascripts'))    //输出main.js到文件夹
//         .pipe(rename({suffix: '.min'}))   //rename压缩后的文件名
//         .pipe(uglify())    //压缩
//         .pipe(gulp.dest('public/dest'));  //输出
// });

// gulp.task('clean', function(cb) {
//     del(['public/dest/*.js'], cb)
// });
...
var
    ...
    del = require('del'); //提示信息

// 压缩html
gulp.task('html', function() {
    del('public/html/**/*.html');
